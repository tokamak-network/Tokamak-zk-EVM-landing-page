...
![comparison document_image01.png](Tokamak%20Private%20App%20Channels%20A%20Comparative%20Analysi/a21992e2-6f75-43df-87b6-d03d39f7a6cb.png)
...
- [Aleo:](https://www.notion.so/Tokamak-Private-App-Channels-A-Comparative-Analysis-30b30540582c81178441e988c6299062?pvs=21) State follows a **record-based model**, without a global shared state. Each transaction updates records within Aleo’s Layer 1 execution environment.
...
![2chanletypes.png](Tokamak%20Private%20App%20Channels%20A%20Comparative%20Analysi/08d50c59-d754-489a-b801-63e0c3232da8.png)
...
| --- | --- | --- |
| **Tokamak:** Private App Channels | • Isolated execution via private channels
• Ethereum settlement
• Scoped privacy and localized failure domains | • Limited global composability
• Smaller anonymity sets
• Economic model not yet finalized |
| **Aztec:** Global zk-Rollup | • Large global anonymity set
• Strong composability
• Ethereum-aligned settlement | • Shared failure domain
• Higher data availability and proving overhead
• Global state complexity |
| **Aleo:**  Standalone L1 | • Native privacy at Layer 1
• Record-based execution model | • Separate security domain from Ethereum
• New language and ecosystem required |
| **Penumbra:** Cosmos App Chain | • Built-in shielded pool
• Protocol-level privacy
• Cosmos/IBC integration | • Fixed-function design
• Limited programmability
• Non-Ethereum-native |
| **COTI V2:** Confidential L2 | • EVM compatibility with confidentiality
• Ethereum settlement
• Policy-based disclosure | • Relies on MPC trust assumptions
• Additional coordination and infrastructure complexity |
...
1. [**A Rollup Comparison Framework](https://arxiv.org/abs/2404.16150),**
2. [**Privacy-Preserving Solutions for Blockchain: Review and Challenges](https://ieeexplore.ieee.org/document/8888155),**
3. [**A Survey of Blockchain-Based Privacy Applications**](https://arxiv.org/pdf/2411.16404)
4. [**The Trade-Off Between Anonymity and Accountability in Blockchain: A Framework for Secure and Compliant Systems**](https://www.ijcit.com/index.php/ijcit/article/view/503),
5. [**Tokamak Network**](https://www.tokamak.network/)
6. [**Aztec Documentation**](https://docs.aztec.network/developers/docs/concepts)
7. [**Aleo Developer Documentation**](https://developer.aleo.org/guides/introduction/getting_started/)
8. [**Penumbra Guide**](https://guide.penumbra.zone/)
9. **COTI V2**

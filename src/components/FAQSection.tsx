...
const FAQSection: React.FC = () => {
  ...
  // Generate FAQ Schema for LLM SEO
  const faqSchema = {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Common questions about Tokamak ZKP solutions
          </p>
        </div>
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="p-8 bg-white border border-gray-200/50 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://t.me/+9My2ZmBemYs2YTFk" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center px-6 py-3 bg-[#028bee] text-white font-semibold hover:bg-[#0277d4] transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
